...
2. Store the app ID from the previous step as a GitHub Actions secret in the repository where you want the workflow to run. For more information about storing secrets, see [Using secrets in GitHub Actions](/en/actions/security-guides/encrypted-secrets).
