...
For more information, see [About webhooks](/en/webhooks/about-webhooks) and [Creating webhooks](/en/webhooks/using-webhooks/creating-webhooks).
...
You can use the GitHub web interface or the REST API to delete a webhook for a repository. For more information about using the REST API to delete a repository webhook, see [REST API endpoints for repository webhooks](/en/rest/webhooks/repos#delete-a-repository-webhook).
...
You can use the GitHub web interface or the REST API to delete an organization webhook. For more information about using the REST API to delete an organization webhook, see [REST API endpoints for organization webhooks](/en/rest/orgs/webhooks#delete-an-organization-webhook).
