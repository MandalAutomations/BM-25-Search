...
This article describes how to write a script to find and redeliver failed deliveries for a repository webhook. For more information about failed deliveries, see [Handling failed webhook deliveries](/en/webhooks/using-webhooks/handling-failed-webhook-deliveries).
