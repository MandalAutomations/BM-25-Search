...
> \[!NOTE]
> Dependabot alerts are configured in the repository or organization "Settings" tab and not in the `dependabot.yml` file, see [Configuring Dependabot alerts](/en/code-security/dependabot/dependabot-alerts/configuring-dependabot-alerts).
...
* Configure your repository so that Dependabot automatically updates the packages you use, see [Configuring Dependabot version updates](/en/code-security/how-tos/secure-your-supply-chain/secure-your-dependencies/configuring-dependabot-version-updates)