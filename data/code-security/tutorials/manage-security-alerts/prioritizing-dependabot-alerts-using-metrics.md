...
* **Alerts closed in the last 30 days, including the number of alerts fixed by Dependabot, manually dismissed, and auto dismissed**: Tracks alert resolution progress. Illustrates how GitHub Code Security can help you detect vulnerabilities early.
...
For more information about these metrics, see [About metrics for Dependabot alerts](/en/code-security/concepts/supply-chain-security/about-metrics-for-dependabot-alerts).

Additionally, you can specify complex filters, which are combinations of the individual filters that are available. For more information about filters, see [Dependabot dashboard view filters](/en/code-security/security-overview/filtering-alerts-in-security-overview#dependabot-dashboard-view-filters).

## Steps to prioritize alerts

These first steps help you identify the Dependabot alerts that put your organization the most at risk, so that you can tell your developers which alerts to focus on for remediation.

### 1. Tailor the funnel order to suit your organization's needs

You can customize the default funnel order on the "Alert prioritization" graph to ensure it reflects the unique risk profile, business priorities, and compliance requirements of your organization. See [Viewing metrics for Dependabot alerts](/en/code-security/security-overview/viewing-metrics-for-dependabot-alerts#configuring-funnel-categories).
...
2. Use the "Older" filter in the **Sort** dropdown list, as well as other sorting criteria, to fine-tune the visualization to alerts meeting your criteria by age.

### 6. Leverage automation

Use Dependabot’s automated pull requests to quickly remediate vulnerabilities. Integrate these updates into your CI/CD pipeline for faster resolution and improved efficiency.
