...
> \[!TIP]
> This article is part of a series on adopting GitHub Advanced Security at scale. For the introduction to this series, see [Introduction to adopting GitHub Advanced Security at scale](/en/enterprise-cloud@latest/code-security/adopting-github-advanced-security-at-scale/introduction-to-adopting-github-advanced-security-at-scale).
...
> \[!TIP]
> For the next article in this series, see [Phase 2: Preparing to enable at scale](/en/enterprise-cloud@latest/code-security/adopting-github-advanced-security-at-scale/phase-2-preparing-to-enable-at-scale).