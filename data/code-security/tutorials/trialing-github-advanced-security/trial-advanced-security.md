...
1. You are an owner of an enterprise account. See [Enterprise accounts](/en/enterprise-cloud@latest/admin/overview/about-enterprise-accounts).
...
>
> * Under "How many committers do you want to include?", enter the number of committers you want to purchase licenses for. See [Active committers and unique committers](/en/billing/managing-billing-for-your-products/managing-billing-for-github-advanced-security/about-billing-for-github-advanced-security#active-committers-and-unique-committers).

## Next steps

1. [Enabling security features in your trial enterprise](/en/code-security/trialing-github-advanced-security/enable-security-features-trial)
2. [Exploring your enterprise trial of GitHub Secret Protection](/en/code-security/trialing-github-advanced-security/explore-trial-secret-scanning)
3. [Exploring your enterprise trial of GitHub Code Security](/en/code-security/trialing-github-advanced-security/explore-trial-code-scanning)