...
The overview dashboard of security overview displays security alert metrics for your organization.
...
For more information, see [Viewing metrics for secret scanning push protection](/en/code-security/security-overview/viewing-metrics-for-secret-scanning-push-protection).
...
### Pull request alerts fixed with Copilot Autofix suggestions

Ratio of accepted to total Copilot Autofix suggestions on pull request alerts.

**Copilot Autofix** provides targeted fix recommendations for code scanning alerts. For more information, see [Responsible use of Copilot Autofix for code scanning](/en/code-security/code-scanning/managing-code-scanning-alerts/responsible-use-autofix-code-scanning).