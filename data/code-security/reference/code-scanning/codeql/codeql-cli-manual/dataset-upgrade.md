...
[codeql database upgrade](/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/database-upgrade) but works on a raw dataset rather than an entire database.
