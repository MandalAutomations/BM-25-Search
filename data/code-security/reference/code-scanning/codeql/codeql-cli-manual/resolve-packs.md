...
This command shows all of the locations searched for CodeQL packs, based
on the specified search path options. For each searched location, it
lists the packs that were found in that location.
