...
This command is deprecated. Use the [codeql resolve packs](/en/code-security/reference/code-scanning/codeql/codeql-cli-manual/resolve-packs) command instead.
