...
list of "well-known" query suite definitions found in available QL
...
`bylanguage`: A richer JSON representation that groups queries by which
extractor they work with, as deduced from their library dependencies --
this is slightly more expensive to compute.

`installedpacks`: \[Deep plumbing] A JSON representation listing CodeQL
