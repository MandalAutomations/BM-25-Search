...
5. In the "Passkeys" section, deselect **Enable passkeys**.
...
* [About passkeys](/en/enterprise-server@3.20/authentication/authenticating-with-a-passkey/about-passkeys)