...
Ensure that your domain settings are properly configured before booting up GitHub.com for the first time.
...
5. To test your appliance's DNS and SSL settings, under "Hostname", click **Test domain settings**.

6. If you don't receive a green checkmark next to all entries, review your configuration for the setting that failed. For more information, see [Configuring DNS nameservers](/en/enterprise-server@3.20/admin/configuration/configuring-network-settings/configuring-dns-nameservers).
