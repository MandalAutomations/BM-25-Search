...
If subdomain isolation is disabled for your enterprise, you should also disable GitHub Pages to protect yourself from potential security vulnerabilities. For more information, see [Enabling subdomain isolation](/en/enterprise-server@3.20/admin/configuration/configuring-network-settings/enabling-subdomain-isolation).
...
* [Enabling private mode](/en/enterprise-server@3.20/admin/configuration/configuring-your-enterprise/enabling-private-mode)