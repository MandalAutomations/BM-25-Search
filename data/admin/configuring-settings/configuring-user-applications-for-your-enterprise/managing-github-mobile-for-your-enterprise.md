...
You can decide whether people can use GitHub Mobile to connect to GitHub.com.

## About GitHub Mobile

GitHub Mobile allows people to triage, collaborate, and manage work on your GitHub Enterprise Server instance from a mobile device after successful authentication. GitHub Mobile is available as an Android and iOS app. For more information, see [GitHub Mobile](/en/enterprise-server@3.20/get-started/using-github/github-mobile).
...
6. In the "Settings" sidebar, click **Mobile**.

7. Under "GitHub Mobile", select or deselect **Enable GitHub Mobile Apps**.
