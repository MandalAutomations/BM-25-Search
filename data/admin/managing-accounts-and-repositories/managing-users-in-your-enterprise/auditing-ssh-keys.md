...
When a new user adds an SSH key to an account, to confirm the user's access, GitHub Enterprise Server will prompt for authentication. For more information, see [Sudo mode](/en/enterprise-server@3.20/authentication/keeping-your-account-and-data-secure/sudo-mode).
