...
You can add people directly to your enterprise.
...
Users will join the enterprise as unaffiliated users. You can then add users to organizations or enterprise teams and assign Copilot licenses to them. For more information about unaffiliated users, see [Abilities of roles in an enterprise](/en/enterprise-cloud@latest/admin/managing-accounts-and-repositories/managing-roles-in-your-enterprise/abilities-of-roles#unaffiliated-users).
