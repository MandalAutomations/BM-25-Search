...
Create roles with fine-grained permissions for consistent access to settings and resources.
...
You can manage role assignments at scale using teams. Learn about teams in your enterprise and organizations in [Teams in an enterprise](/en/enterprise-cloud@latest/admin/concepts/enterprise-fundamentals/teams-in-an-enterprise).