...
For more information, see [About Git Large File Storage](/en/enterprise-server@3.20/repositories/working-with-files/managing-large-files/about-git-large-file-storage), [Managing large files](/en/enterprise-server@3.20/repositories/working-with-files/managing-large-files), and the [Git Large File Storage project site](https://git-lfs.com/).
...
4. Migrate any existing Git LFS assets. For more information, see [Migrating to a different Git Large File Storage server](#migrating-to-a-different-git-large-file-storage-server).
