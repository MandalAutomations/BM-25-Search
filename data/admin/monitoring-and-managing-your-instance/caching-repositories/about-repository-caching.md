...
You can configure repository caching by creating a special type of replica called a repository cache. For more information, see [Configuring a repository cache](/en/enterprise-server@3.20/admin/enterprise-management/caching-repositories/configuring-a-repository-cache).
