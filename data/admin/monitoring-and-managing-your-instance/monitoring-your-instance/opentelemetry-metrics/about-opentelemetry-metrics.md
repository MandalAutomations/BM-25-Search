...
With OpenTelemetry, advanced Grafana dashboards with enhanced visualization and monitoring capabilities are available, see: [Advanced dashboards of OpenTelemetry metrics](/en/enterprise-server@3.20/admin/monitoring-and-managing-your-instance/monitoring-your-instance/opentelemetry-metrics/advanced-dashboards).
...
* **VictoriaMetrics**: A fast, efficient, and scalable time-series database that stores all metrics collected from your GitHub Enterprise Server instance
...
* **Exporters**: Specialized components that collect metrics from specific services, including:
  ...
  * [StatsD exporter](https://github.com/prometheus/statsd_exporter): Used by GitHub components to expose application-level metrics using the StatsD protocol
...
* **Custom metrics services**: Additional GitHub-specific services that push OpenTelemetry metrics directly to the collector, including:
...
* To enable and configure OpenTelemetry metrics, see [Configuring OpenTelemetry for your instance](/en/enterprise-server@3.20/admin/monitoring-and-managing-your-instance/monitoring-your-instance/opentelemetry-metrics/configuring-opentelemetry-for-your-instance).
