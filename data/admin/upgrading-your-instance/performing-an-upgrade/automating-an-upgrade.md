...
* Ensure you can authenticate to the Manage GitHub Enterprise Server API. For more information, see [REST API endpoints for GitHub Enterprise administration](/en/enterprise-server@3.22/rest/enterprise-admin#authentication).
