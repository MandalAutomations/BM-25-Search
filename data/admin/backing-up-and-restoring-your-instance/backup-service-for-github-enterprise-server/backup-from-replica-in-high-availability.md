...
To configure your backup server on a replica, run the following commands. See [Configuring the backup service](/en/enterprise-server@3.20/admin/backing-up-and-restoring-your-instance/backup-service-for-github-enterprise-server/configuring-the-backup-service).
