...
Reference for all configurable options available in the Backup Service section of the Management Console.

You can configure the following options in the "Backup Service" section of the Management Console.
