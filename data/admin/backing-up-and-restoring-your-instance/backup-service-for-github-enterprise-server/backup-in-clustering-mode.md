...
1. To configure your backup server, run the following commands to set up a backup disk on one of the cluster nodes of your choice. See [Configuring the backup service](/en/enterprise-server@3.20/admin/backing-up-and-restoring-your-instance/backup-service-for-github-enterprise-server/configuring-the-backup-service).
