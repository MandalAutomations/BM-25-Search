...
Creating organizations is a balance. While GitHub continues to make organization management more scalable, you should be intentional about why you create an organization. It's always easier to add organizations than to remove them.
...
For guidance on setting up effective innersource practices, see [Using innersource in your enterprise](/en/enterprise-cloud@latest/admin/concepts/enterprise-best-practices/use-innersource).

## Next steps

Learn how to set up your enterprise according to best practices in our [Enterprise onboarding](/en/enterprise-cloud@latest/enterprise-onboarding) journey for GitHub Enterprise Cloud.