...
Learn how roles allow you to control people's access to your enterprise's settings and resources.
...
Organization and enterprise roles can be **predefined** or **custom**. Enterprise custom roles are in public preview.
...
Now that you understand roles, plan which roles will be required for your teams to do their jobs on GitHub. See [Identifying the roles required by your enterprise](/en/enterprise-cloud@latest/admin/managing-accounts-and-repositories/managing-roles-in-your-enterprise/identify-role-requirements).