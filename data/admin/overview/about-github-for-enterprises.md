...
* Automate detection and remediation of vulnerabilities in code and dependencies using GitHub Code Security
* Block users from leaking secrets and identify and remediate historic leaks using GitHub Secret Protection
...
* Additional features such as SAML authentication and internal repositories. For a detailed list, see [GitHub Pricing](https://github.com/pricing).
* Extra allowances for usage-based products such as GitHub Actions.
* The option to add <!-- Enterprise is no longer a pre-requisite with the GHAS products release -->GitHub Premium Support, and GitHub Copilot Enterprise.

When businesses adopt GitHub Enterprise, their return on investment (ROI) is high. For example, their developers **save 45 minutes per day**, and onboarding and **training time is reduced by 40%**. See [The Total Economic Impact of GitHub Enterprise](https://resources.github.com/forrester/).
...
Get started with our [Enterprise onboarding](/en/enterprise-cloud@latest/enterprise-onboarding) journey for GitHub Enterprise Cloud.