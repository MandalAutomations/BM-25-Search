...
* New organizations in your enterprise are automatically added to your enterprise account. To add organizations that existed before your school joined the GitHub Campus Program, please contact us through the [GitHub Support portal](https://support.github.com). For more information about administrating your enterprise, see the [enterprise administrators documentation](/en/enterprise-cloud@latest/admin).

To read more about GitHub's privacy practices, see [GitHub General Privacy Statement](/en/site-policy/privacy-policies/github-privacy-statement).
...
For more information, see the [official GitHub Campus Program](https://education.github.com/schools) page or visit the [GitHub Education Resource Guide](https://github.com/github-education-resources/edu-resource-guide?tab=readme-ov-file#github-education-resource-guide).
