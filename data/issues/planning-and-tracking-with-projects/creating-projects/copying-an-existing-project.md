...
You can also set projects in your organization as templates, and curate a list of recommended templates to highlight,  that other organization members can then use as the base for the projects they create. For more information, see [Managing project templates in your organization](/en/issues/planning-and-tracking-with-projects/managing-your-project/managing-project-templates-in-your-organization).
