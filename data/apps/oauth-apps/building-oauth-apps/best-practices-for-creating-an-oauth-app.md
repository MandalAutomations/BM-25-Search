...
For more information about GitHub Apps, see [About creating GitHub Apps](/en/apps/creating-github-apps/setting-up-a-github-app/about-creating-github-apps).

For more information about migrating an existing OAuth app to a GitHub App, see [Migrating OAuth apps to GitHub Apps](/en/apps/creating-github-apps/guides/migrating-oauth-apps-to-github-apps).
...
Client secrets are required to generate user access tokens for your app, unless your app uses the device flow. For more information, see [Authorizing OAuth apps](/en/apps/oauth-apps/building-oauth-apps/authorizing-oauth-apps#device-flow).
...
In the event that user access tokens are compromised, you should immediately revoke these tokens. For more information, see [REST API endpoints for OAuth authorizations](/en/rest/apps/oauth-applications#delete-an-app-token).
