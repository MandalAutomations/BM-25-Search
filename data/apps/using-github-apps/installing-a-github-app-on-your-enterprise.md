...
If you need to install the same app in many organizations, you can automate this with an API. See [Automating app installations in your enterprise's organizations](/en/enterprise-cloud@latest/admin/managing-github-apps-for-your-enterprise/automate-installations).

## Next steps

* To grant the app access to specific organizations, install it on those organizations. For more information, see [Installing a GitHub App from a third party](/en/enterprise-cloud@latest/apps/using-github-apps/installing-a-github-app-from-a-third-party).
* Learn about managing apps installed in your organizations. For more information, see [Reviewing and modifying installed GitHub Apps](/en/enterprise-cloud@latest/apps/using-github-apps/reviewing-and-modifying-installed-github-apps).