...
Webhooks enable your GitHub App to receive real-time notifications when events happen on GitHub, such as when someone pushes a commit or opens a pull request in a repository that your app can access. For more information about webhooks, see [About webhooks](/en/webhooks-and-events/webhooks/about-webhooks). For a tutorial that demonstrates how to use webhooks with a GitHub App, see [Building a GitHub App that responds to webhook events](/en/apps/creating-github-apps/guides/building-a-github-app-that-responds-to-webhook-events).

You can configure your GitHub App to receive webhooks for specific events on GitHub and automatically take action on them. For more information about the types of webhooks you can receive, see [Webhook events and payloads](/en/webhooks-and-events/webhooks/webhook-events-and-payloads).
...
After creating a webhook secret for your app, you will need to configure your server to securely store and validate the webhook secret token. For more information, see [Validating webhook deliveries](/en/webhooks-and-events/webhooks/securing-your-webhooks).
...
For more information about the permissions that are required for each webhook event, see [Webhook events and payloads](/en/webhooks-and-events/webhooks/webhook-events-and-payloads).