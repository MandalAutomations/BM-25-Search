...
If the repository is stored on GitHub Enterprise Server, a site administrator can also unlock the repository using the site admin dashboard. For more information, see [Locking a repository](/en/enterprise-server@3.20/admin/user-management/managing-repositories-in-your-enterprise/locking-a-repository) in the GitHub Enterprise Server documentation.
...
If you're sure you want to use the repository, a site administrator can unlock the repository using the site admin dashboard. For more information, see [Locking a repository](/en/enterprise-server@3.20/admin/user-management/managing-repositories-in-your-enterprise/locking-a-repository) in the GitHub Enterprise Server documentation.
