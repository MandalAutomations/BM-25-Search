...
2. Download the latest version of GitHub Desktop.
3. In your "Downloads" folder, locate the downloaded application.
4. If the downloaded application is in a zip file, unpack the file by double clicking on the zip file.
5. Drag the GitHub Desktop application from your "Downloads" folder to the "Applications" folder.
6. Approve the dialog asking if you want to replace the existing application.
7. Launch GitHub Desktop.
8. Approve the prompt stating that application was downloaded from the internet.
