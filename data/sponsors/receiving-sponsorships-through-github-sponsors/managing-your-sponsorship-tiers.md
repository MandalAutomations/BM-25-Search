...
5. Optionally, in the text boxes in the "Custom amounts" section, type a recommended or minimum sponsorship amount. The minimum amount applies to both recurring and one-time sponsorships.

6. Optionally, to edit a draft tier, find the draft tier and click **Edit**.

7. To create a monthly tier, click **Add a monthly tier** at the right of the page. Alternatively, to create a tier for one-time payments, click **One-time tiers** and then click **Add a one-time tier**.

8. Type a price per month and description for the tier.

9. Optionally, to add a welcome message for the tier, select **Display welcome message**, then type your message in the text field that appears.

10. Click **Save draft**.

11. Proofread your tier, then click **Publish tier**.
...
4. To the right of the tier you want to edit, click **Edit**.
...
7. To retire a tier, click **Retire tier**, then click **OK**.
...
When you add a repository to a tier, GitHub will automatically send repository invitations to new sponsors and remove access when a sponsorship is canceled.
...
6. Select the dropdown menu that appears and click the repository you want to add.
...
7. Proofread your tier, then click **Update**.