...
5. In the "What is your goal based on?" section, select **Number of monthly sponsors** or **Sponsorships a month**.
6. Type the number of monthly sponsors you'd like to have, or the monthly amount you're aiming for.
7. In the "Describe your goal" section, type a description for your goal.
...
3. In the left sidebar, click **Your goals**.
   ...
   ![Screenshot of the sidebar on the GitHub Sponsors dashboard. A tab in the "Profile" section, labeled "Your goals", is outlined in dark orange.](/assets/images/help/sponsors/your-goals-tab.png)
4. To the right of your goal, click **Edit**.
5. In the "What is your goal based on?" section, select **Number of monthly sponsors** or **Sponsorships a month**.
6. Type the number of monthly sponsors you'd like to have, or the monthly amount you're aiming for.
7. In the "Describe your goal" section, type a description for your goal.
8. If you chose a goal based on sponsorships per month, select **I understand that this will publicly display how much sponsorship funds I receive each month**.
...
3. In the left sidebar, click **Your goals**.
   ...
   ![Screenshot of the sidebar on the GitHub Sponsors dashboard. A tab in the "Profile" section, labeled "Your goals", is outlined in dark orange.](/assets/images/help/sponsors/your-goals-tab.png)
4. To the right of your goal, click **Edit**.
5. At the bottom of the page, click **Retire**.
6. In the modal that appears, read the warning, then click **OK**.
...
3. In the left sidebar, click **Your goals**.
   ...
   ![Screenshot of the sidebar on the GitHub Sponsors dashboard. A tab in the "Profile" section, labeled "Your goals", is outlined in dark orange.](/assets/images/help/sponsors/your-goals-tab.png)
4. Under your goal, click the **Share** or **Embed it** button.