...
To join GitHub Sponsors as an individual contributor outside an organization, see [Setting up GitHub Sponsors for your personal account](/en/sponsors/receiving-sponsorships-through-github-sponsors/setting-up-github-sponsors-for-your-personal-account).
...
8. Optionally, select **Optional: Opt-in to get featured on github.com/sponsors**.
...
Before your organization can become a sponsored organization, you must enable 2FA for your account on GitHub. For more information, see [Configuring two-factor authentication](/en/authentication/securing-your-account-with-two-factor-authentication-2fa/configuring-two-factor-authentication).
