...
For GitHub.com and GitHub Enterprise Cloud, GitHub automatically scans *secret gists* for partner secrets and informs the relevant partner whenever one of their secrets is leaked. See [About secret scanning for partners](/en/code-security/secret-scanning/introduction/about-secret-scanning-for-partners).
...
You can pin gists to your profile so other people can see them easily. For more information, see [Pinning items to your profile](/en/account-and-profile/setting-up-and-managing-your-github-profile/customizing-your-profile/pinning-items-to-your-profile).
