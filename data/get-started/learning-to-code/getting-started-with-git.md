...
1. In GitHub Desktop, if you aren't on the `main` branch, select the <svg version="1.1" width="16" height="16" viewBox="0 0 16 16" class="octicon octicon-git-branch" aria-label="git-branch" role="img"><path d="M9.5 3.25a2.25 2.25 0 1 1 3 2.122V6A2.5 2.5 0 0 1 10 8.5H6a1 1 0 0 0-1 1v1.128a2.251 2.251 0 1 1-1.5 0V5.372a2.25 2.25 0 1 1 1.5 0v1.836A2.493 2.493 0 0 1 6 7h4a1 1 0 0 0 1-1v-.628A2.25 2.25 0 0 1 9.5 3.25Zm-6 0a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Zm8.25-.75a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5ZM4.25 12a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Z"></path></svg> **Current Branch** dropdown menu, then click **main**.
...
1. In GitHub Desktop, press <kbd>Ctrl</kbd>+<kbd>\`</kbd> to open your project on the command line.
...
5. Install GitHub Copilot CLI, so that you can use Copilot from the command line. See [Installing GitHub Copilot CLI](/en/copilot/how-tos/set-up/install-copilot-cli).
...
When Copilot asks what kind of command you're looking for, use your arrow keys to choose **git command**, then press <kbd>Enter</kbd>. Copilot will then suggest the following command:
...
Now, try applying what you've learned to your own work. Add Git to an existing project with GitHub Desktop by pressing <kbd>Ctrl</kbd>+<kbd>O</kbd> (Windows/Linux) or <kbd>Command</kbd>+<kbd>O</kbd> (Mac) and experience the benefits of version control yourself!