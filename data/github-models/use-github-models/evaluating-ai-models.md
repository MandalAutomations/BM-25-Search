...
To familiarize yourself with how to create and manage prompts in GitHub Models, see [Testing a prompt in the Playground](/en/github-models/use-github-models/optimizing-your-ai-powered-app-with-github-models#testing-a-prompt-in-the-playground).
...
Alternatively, you can add variables in your `.prompt.yml` file system or user prompt to automate the process of evaluating with multiple variables in the future. See [Storing prompts in GitHub repositories](/en/github-models/use-github-models/storing-prompts-in-github-repositories).
...
To the right of the table, click <svg version="1.1" width="16" height="16" viewBox="0 0 16 16" class="octicon octicon-plus" aria-label="Add prompt configuration" role="img"><path d="M7.75 2a.75.75 0 0 1 .75.75V7h4.25a.75.75 0 0 1 0 1.5H8.5v4.25a.75.75 0 0 1-1.5 0V8.5H2.75a.75.75 0 0 1 0-1.5H7V2.75A.75.75 0 0 1 7.75 2Z"></path></svg> to add a new prompt configuration.
...
* [Configuring access to AI models in GitHub Copilot](/en/github-models/use-github-models/integrating-ai-models-into-your-development-workflow)