...
Build your own tools that seamlessly integrate with GitHub APIs. For more information, see [Comparing GitHub's REST API and GraphQL API](/en/rest/about-the-rest-api/comparing-githubs-rest-api-and-graphql-api).
