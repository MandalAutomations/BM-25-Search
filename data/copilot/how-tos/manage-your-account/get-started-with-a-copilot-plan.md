...
* [Subscribing to Copilot Pro or Copilot Pro+](#subscribing-to-copilot-pro-or-copilot-pro)
...
## Subscribing to Copilot Pro or Copilot Pro+
...
> \[!TIP] Not sure which plan to choose? For a side-by-side comparison, see [About individual GitHub Copilot plans and benefits](/en/copilot/managing-copilot/managing-copilot-as-an-individual-subscriber/getting-started-with-copilot-on-your-personal-account/about-individual-copilot-plans-and-benefits).
...
3. Click **Subscribe to Copilot Pro/Copilot Pro+**.
