...
On June 1, 2026, Copilot is moving to usage-based billing with GitHub AI Credits. **Starting in early May**, use the tools below to understand how this change affects you before the transition takes effect.

<!-- end expires 2026-06-01 -->

## Preview your bill (coming in early May)

From the announcement banner on the premium request analytics page, click **Preview my bill** to see how your current usage translates to GitHub AI Credits.
