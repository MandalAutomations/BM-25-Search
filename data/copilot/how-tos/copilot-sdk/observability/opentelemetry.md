...
GitHub Copilot SDK has built-in support for configuring OpenTelemetry on the CLI process and propagating W3C Trace Context between the SDK and CLI.

For examples in Python, Go, and .NET, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/observability/opentelemetry.md). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
