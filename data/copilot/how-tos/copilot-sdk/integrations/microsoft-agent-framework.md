...
Use Copilot SDK as an agent provider inside the [Microsoft Agent Framework](https://devblogs.microsoft.com/semantic-kernel/build-ai-agents-with-github-copilot-sdk-and-microsoft-agent-framework/) (MAF) to compose multi-agent workflows alongside Azure OpenAI, Anthropic, and other providers.
...
> \[!NOTE]
> MAF integration packages are available for .NET and Python. For TypeScript and Go, use the Copilot SDK directly—the standard SDK APIs provide tool calling, streaming, and custom agents.

## Prerequisites

Before you begin, make sure you have:

* A working Copilot SDK setup in your language of choice. See [Getting started with Copilot SDK](/en/copilot/how-tos/copilot-sdk/sdk-getting-started).
* A GitHub Copilot subscription (Individual, Business, or Enterprise).
* Copilot CLI installed or available via the SDK's bundled CLI.

## Installation

Install the Copilot SDK alongside the MAF integration package:
...
You can also use the Copilot SDK's native tool definition alongside MAF tools:
