...
For examples in Python, Go, and .NET, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/image-input.md#quick-start--file-attachment). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
...
For examples in Python, Go, and .NET, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/image-input.md#quick-start--blob-attachment). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
...
These image blocks appear in `tool.execution_complete` event results. For more information, see [Streaming events in the Copilot SDK](/en/copilot/how-tos/copilot-sdk/use-copilot-sdk/streaming-events).
...
* [Streaming events in the Copilot SDK](/en/copilot/how-tos/copilot-sdk/use-copilot-sdk/streaming-events)—event lifecycle including tool result content blocks
* [Steering and queueing messages in the Copilot SDK](/en/copilot/how-tos/copilot-sdk/use-copilot-sdk/steering-and-queueing)—sending follow-up messages with attachments