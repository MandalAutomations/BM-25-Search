...
For examples in Python, Go, and .NET, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/mcp.md#configuration). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
