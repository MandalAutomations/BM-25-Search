...
When you create a session, Copilot SDK maintains conversation history, tool state, and planning context. By default, this state lives in memory and disappears when the session ends. With persistence enabled, you can resume sessions across restarts, container migrations, or even different client instances. For a visual overview of the session state lifecycle, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/session-persistence.md#how-sessions-work).
...
For examples in Python, Go, and C#, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/session-persistence.md#resuming-a-session). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
...
For an example in Python, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/session-persistence.md#example-generating-session-ids). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
