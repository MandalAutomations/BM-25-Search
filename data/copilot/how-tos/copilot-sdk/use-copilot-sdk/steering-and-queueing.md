...
For examples in Python, Go, and .NET, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/steering-and-queueing.md#steering-immediate-mode). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
...
For examples in Python, Go, and .NET, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/steering-and-queueing.md#queueing-enqueue-mode). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
...
For an example in Python, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/steering-and-queueing.md#combining-steering-and-queueing). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
...
You can use the Copilot SDK session API to steer and queue sessions.
