...
Hooks let you plug custom logic into every stage of a Copilot SDK session—from the moment it starts, through each user prompt and tool call, to the moment it ends. You can use hooks to implement permissions, auditing, notifications, and more without modifying the core agent behavior.
...
For examples in Python, Go, and .NET, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/hooks.md#registering-hooks). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
...
For examples in Python, Go, and .NET, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/hooks.md#allow-list-a-safe-set-of-tools). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
...
For an example in Python, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/hooks.md#structured-audit-log). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
...
For an example in Python, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/hooks.md#desktop-notification-on-session-events). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
...
For an example in Python, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/hooks.md#session-metrics). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
