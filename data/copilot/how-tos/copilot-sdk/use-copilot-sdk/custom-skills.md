...
For examples in Python, Go, and .NET, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/skills.md#loading-skills). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
...
For examples in Python, Go, and .NET, see the [`github/copilot-sdk` repository](https://github.com/github/copilot-sdk/blob/main/docs/features/skills.md#disabling-skills). For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
