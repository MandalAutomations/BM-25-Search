...
For examples in Python, Go, and .NET, see [Debugging Guide](https://github.com/github/copilot-sdk/blob/main/docs/troubleshooting/debugging.md) in the `github/copilot-sdk` repository. For Java, see the [`github/copilot-sdk-java` repository](https://github.com/github/copilot-sdk-java).
...
**Cause:** GitHub Copilot CLI is not installed or not in PATH.

**Solution:**

1. Install the CLI. For more information, see [Installing GitHub Copilot CLI](/en/copilot/how-tos/copilot-cli/install-copilot-cli).
...
MCP (Model Context Protocol) servers can be tricky to debug. For comprehensive MCP debugging guidance, see [Debugging MCP servers in Copilot SDK](/en/copilot/how-tos/copilot-sdk/troubleshooting/debug-mcp-servers).
...
For detailed troubleshooting, see [Debugging MCP servers in Copilot SDK](/en/copilot/how-tos/copilot-sdk/troubleshooting/debug-mcp-servers).
...
2. **Console encoding:** Ensure UTF-8 for proper JSON handling. For .NET-specific examples, see [Debugging Guide](https://github.com/github/copilot-sdk/blob/main/docs/troubleshooting/debugging.md) in the `github/copilot-sdk` repository.
