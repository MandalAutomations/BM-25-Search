...
See [Image input](/en/copilot/how-tos/copilot-sdk/features/image-input) for the attachment API and the `file` and `blob` attachment shapes.
...
* [Streaming session events](/en/copilot/how-tos/copilot-sdk/features/streaming-events): subscribe to session events and narrow event types
* [Image input](/en/copilot/how-tos/copilot-sdk/features/image-input): attach files and in-memory blobs to a message
* [Session resume and persistence](/en/copilot/how-tos/copilot-sdk/features/session-persistence): resume sessions and re-apply session options
* [SDK and CLI compatibility](/en/copilot/how-tos/copilot-sdk/troubleshooting/compatibility): SDK and CLI feature matrix