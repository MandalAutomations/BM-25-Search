...
* For more information about configuring hooks, see [Hooks configuration](/en/copilot/reference/hooks-configuration)
...
* For more information about GitHub Copilot CLI, see [About GitHub Copilot CLI](/en/copilot/concepts/agents/about-copilot-cli)
* For information about customizing the agent environment, see [Customizing the development environment for GitHub Copilot cloud agent](/en/copilot/how-tos/use-copilot-agents/cloud-agent/customize-the-agent-environment)