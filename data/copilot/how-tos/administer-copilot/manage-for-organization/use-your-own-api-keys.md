...
You can bring your own API keys to GitHub Copilot, and enable teams to use your preferred large language model (LLM) providers with GitHub Copilot Chat and GitHub Copilot CLI.
...
After you've added your key and selected one or more models, you and your organization members will be able to use them with GitHub Copilot Chat and GitHub Copilot CLI. Your models will appear at the bottom of the model picker, under the organization name.
...
5. Under "Copilot", click **Models**.

6. Click the **Custom models** tab.

7. Above the list of API keys, click **Add API key**.

8. Under "Provider", select the LLM provider you want to use.

9. Under "Name", type a name for this key. This will be shown in the model picker.

10. Under "API key", type or paste your key.

11. Depending on which provider you are using, select or add models.
...
12. After you select or add the models you want to make available, click **Save**.
