...
After you've added your key and selected one or more models, you and members of your organizations will be able to use them with GitHub Copilot Chat and GitHub Copilot CLI. Your models will appear at the bottom of the model picker, under the enterprise name.
