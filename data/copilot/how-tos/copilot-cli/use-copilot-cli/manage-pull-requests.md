...
Subcommands that commit and push changes will prompt you for permission before performing potentially destructive actions, unless you have pre-allowed those tools. For more information, see [Allowing and denying tool use](/en/copilot/how-tos/copilot-cli/allowing-tools).
