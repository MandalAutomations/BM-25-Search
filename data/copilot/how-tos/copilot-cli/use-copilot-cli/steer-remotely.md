...
If you always want your interactive CLI sessions to be remotely accessible, add the following to your Copilot configuration file (typically located at `~/.copilot/settings.json`):
