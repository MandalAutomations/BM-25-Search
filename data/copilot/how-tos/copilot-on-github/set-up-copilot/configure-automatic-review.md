...
You can configure Copilot code review to review pull requests automatically. For an overview of automatic pull request reviews, see [About GitHub Copilot code review](/en/copilot/concepts/code-review#about-automatic-pull-request-reviews).
