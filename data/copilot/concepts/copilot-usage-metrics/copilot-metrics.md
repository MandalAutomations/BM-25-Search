...
* The Copilot usage metrics APIs, which provide detailed, exportable data at the enterprise, organization, and user levels.
...
Copilot usage metrics are derived from telemetry across multiple Copilot surfaces, including IDE and Copilot CLI activity. Because many metrics come from IDE telemetry, **end users must have telemetry enabled in their IDE to be included in these metrics**.
...
**Adoption** measures how many licensed developers are actively using Copilot. For example, daily active users (DAU) tells you how many unique users interacted with Copilot on a given day. Ideally, you'll see a consistent upward trend in these metrics during rollout.
...
* To view adoption and usage trends across your enterprise and organizations, see [Viewing the Copilot usage metrics dashboard](/en/copilot/how-tos/administer-copilot/manage-for-enterprise/view-usage-and-adoption).
* To analyze how code is being generated by users and agents, see [Viewing the code generation dashboard](/en/copilot/how-tos/administer-copilot/manage-for-enterprise/view-code-generation).
