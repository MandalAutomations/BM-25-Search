...
This article gives an overview of the `/fleet` slash command. For details of how to use it, see [Speeding up task completion with the \`/fleet\` command](/en/copilot/how-tos/copilot-cli/speed-up-task-completion).
