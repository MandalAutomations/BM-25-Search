...
* **Custom instructions**
  ...
  These tell Copilot **how to behave** in general. For example, to ensure any code that Copilot writes conforms to your coding standards. [Find out more](#custom-instructions).

* **Skills**

  These tell Copilot **how to handle a specific kind of task**. For example, to use a particular tool when working on a specific type of task. [Find out more](#skills).

* **Tools**

  These **provide abilities**. For example, for finding and modifying files, or for interacting with parts of GitHub. [Find out more](#tools).

* **MCP servers**

  These **add collections of tools** that allow Copilot to interact with external services. [Find out more](#mcp-servers).
