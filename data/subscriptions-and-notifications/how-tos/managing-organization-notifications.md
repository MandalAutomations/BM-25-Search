...
Learn how to control where notifications from your organization are delivered.
...
5. Select the **Pick organization** dropdown, then click the organization you want to customize.
