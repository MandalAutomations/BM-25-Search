...
To help you understand your subscriptions and decide whether to unsubscribe, see [Viewing your subscriptions](/en/subscriptions-and-notifications/managing-subscriptions-for-activity-on-github/viewing-your-subscriptions).

> \[!NOTE]
> Instead of unsubscribing, you have the option to ignore a repository. If you ignore a repository, you won't receive any notifications. We don't recommend ignoring repositories as you won't be notified if you're @mentioned. If you're experiencing abuse and want to ignore a repository, please visit [GitHub Support](https://support.github.com) so we can help. GitHub does not tolerate abuse. For more information on GitHub's policies, see our [Terms of Service](/en/site-policy/github-terms/github-terms-of-service) and [Community Guidelines](/en/site-policy/github-terms/github-community-guidelines).
...
2. From the notifications inbox, select the notifications you want to unsubscribe to.
3. Click **Unsubscribe.**
...
2. In the left sidebar, under the list of repositories, select the "Manage notifications" dropdown menu and click **Subscriptions**.
...
3. Select the notifications you want to unsubscribe from. In the top right, click **Unsubscribe**.
...
2. In the left sidebar, under the list of repositories, select the "Manage notifications" dropdown menu and click **Watched repositories**.

   ![Screenshot of the "Notifications" page. A dropdown menu, titled "Manage notifications", is highlighted with an orange outline.](/assets/images/help/notifications-v2/manage-notifications-options.png)

3. On the watched repositories page, after you've evaluated the repositories you're watching, choose whether to:
...
4. Optionally, to unsubscribe from all repositories owned by a given user or organization, select the **Unwatch all** dropdown and click the organization whose repositories you'd like to unsubscribe from. The button to unwatch all repositories is only available if you are watching all activity or custom notifications on over 10 repositories.
