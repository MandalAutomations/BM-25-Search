...
**"Program Documentation"** means GitHub's published documentation for the Program, currently available at [https://docs.github.com/code-security/secret-scanning/secret-scanning-partner-program](/en/code-security/secret-scanning/secret-scanning-partner-program), as GitHub may update it.
...
Partner's use of GitHub Marks must comply with GitHub's then-current trademark and logo usage guidelines, as published at <https://brand.github.com/guides/getting-started>.
...
All notices under this agreement must be in writing and sent by email. Notices to GitHub must be sent to <secret-scanning@github.com>. Notices to Partner must be sent to the email address Partner provided during onboarding. A notice is deemed received on the business day after it is sent.
