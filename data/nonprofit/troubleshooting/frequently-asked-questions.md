...
Troubleshooting common errors with the GitHub for Nonprofits process.
...
3. In the "Transform account" section, click **Turn USERNAME into an organization**.
4. Read the warning provided, then click **Turn USERNAME into an organization** to confirm.
5. Under "Choose an organization owner," type the username of the new personal account you created or another trusted user to manage the organization.
6. Choose your new organization's subscription plan and enter billing information if prompted.
7. Click **Create Organization** to finalize the process.
...
2. Depending on your environment, click **Your enterprise** or **Your enterprises**. Then click the enterprise you want to view.
...
4. In the search bar, begin typing the organization's name until the organization appears in the search results.
5. To the right of the organization's name, select the dropdown menu and click **Remove organization**.
6. Review the warnings, then click **Remove organization**.
...
3. Click **Redeem**.
4. If you're not already signed in, you can sign in on this page.
5. Under "Redeem your coupon," next to the organization you want to apply the coupon to, click **Choose**.
6. Under "Your new plan," review the information about your plan and discount, then click **Redeem**.
...
Please try logging out of your account, deleting the OAuth app from your account, and then logging in again. For more about deleting the OAuth app from your account, please visit [Learn more about deleting the OAuth app from your account](/en/nonprofit/troubleshooting/cannot-find-my-organization-on-github-for-nonprofits).
