...
You can use the REST and GraphQL APIs to manage rulesets. For more information, see [REST API endpoints for rules](/en/rest/repos/rules) and [Mutations](/en/graphql/reference/mutations#createrepositoryruleset).
...
5. Change the ruleset as required. For information on the available rules, see [Available rules for rulesets](/en/repositories/configuring-branches-and-merges-in-your-repository/managing-rulesets/available-rules-for-rulesets).
...
Additionally, these insights are available via the rule suites [REST API](/en/rest/repos/rule-suites).
