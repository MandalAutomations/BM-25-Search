...
| `total_monthly_quota`       | The number of requests included in the user's current plan. See [About individual GitHub Copilot plans and benefits](/en/copilot/concepts/billing/individual-plans) and [About billing for GitHub Copilot in organizations and enterprises](/en/copilot/concepts/billing/organizations-and-enterprises). <br><br>Only available in the `Premium request usage report` |
