# Costs and multipliers for using GitHub Models directly

Reference information for calculating the cost of using different GitHub Models directly (outside GitHub Copilot).

## Use of models in GitHub

The information in this article is for the direct use of GitHub Models.

GitHub supports using models in two additional ways.

* GitHub Copilot uses models to perform its work, see [Requests in GitHub Copilot](/en/copilot/concepts/billing/copilot-requests#model-multipliers)
* If you use models provided by other companies, see [Using your own API keys in GitHub Models](/en/github-models/github-models-at-scale/using-your-own-api-keys-in-github-models)

## Multipliers and costs for direct use of GitHub Models

The table below lists the currently available models. Each model supported by GitHub Models has an input and output multiplier that determines the number of token units for each request. For more information on token units, see [GitHub Models billing](/en/billing/concepts/product-billing/github-models).
