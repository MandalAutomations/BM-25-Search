...
* GitHub plan subscriptions (Pro, Team, Enterprise)
* GitHub Marketplace purchases
* GitHub Sponsors transactions
...
If you are currently billed monthly, and would like to switch to yearly billing, you can reduce the frequency of your one-time payments. For more information, see [Billing cycles](/en/billing/managing-your-billing/about-the-billing-cycle).
...
In the meantime, we are actively working with our payment partners to restore recurring payments for impacted customers. For more information or questions, you can contact us through the [GitHub Support portal](https://support.github.com).
...
7. Once payment for the current billing cycle has been successfully made, the **Pay now** button on your "Billing & plans" page will be disabled until your next payment is due.