...
For more detailed reports on usage of all paid products, see [Viewing your usage of metered products and licenses](/en/billing/how-tos/products/view-product-use).
...
* Organization-level data (cloud only), use the `/organizations/{org}/settings/billing/usage` endpoint. For more information, see [Budgets](/en/rest/billing/enhanced-billing?apiVersion=2022-11-28).

* Enterprise-level data, use the `/enterprises/{enterprise}/settings/billing/usage` endpoint. For more information, see [REST API endpoints for billing](/en/enterprise-cloud@latest/rest/enterprise-admin/billing?apiVersion=2022-11-28#get-billing-usage-report-for-an-enterprise) in the GitHub Enterprise Cloud documentation.