...
If you use GitHub Enterprise Cloud, you can download a license from your enterprise. For more information, see [License files for GitHub Enterprise Server](/en/enterprise-cloud@latest/billing/concepts/enterprise-billing/ghes-license-files) and [Downloading your license for GitHub Enterprise](/en/enterprise-cloud@latest/billing/managing-your-license-for-github-enterprise/downloading-your-license-for-github-enterprise).
...
You can use the REST API to upload a license to GitHub.com. See [REST API endpoints for managing GitHub Enterprise Server](/en/enterprise-server@3.20/rest/enterprise-admin/manage-ghes#upload-an-enterprise-license) in the documentation for GitHub Enterprise Server.

## Uploading a license with the GitHub CLI

You can import a license to GitHub.com using the `gh es` extension of the GitHub CLI. See the [usage instructions](https://github.com/github/gh-es/blob/main/USAGE.md#gh-es-config-import-license) in the `github/gh-es` repository on GitHub.com.

For more information about accessing your instance via the extension, see [Administering your instance using the GitHub CLI](/en/enterprise-server@3.20/admin/administering-your-instance/administering-your-instance-from-the-command-line/administering-your-instance-using-the-github-cli) in the documentation for GitHub Enterprise Server.

## Uploading a license via SSH

You can upload and interact with your license from the command line via SSH. See the documentation for the `ghe-license` command in [Command-line utilities](/en/enterprise-server@3.20/admin/administering-your-instance/administering-your-instance-from-the-command-line/command-line-utilities#ghe-license) in the documentation for GitHub Enterprise Server.

For more information about accessing your instance via SSH, see [Accessing the administrative shell (SSH)](/en/enterprise-server@3.20/admin/administering-your-instance/administering-your-instance-from-the-command-line/accessing-the-administrative-shell-ssh) in the documentation for GitHub Enterprise Server.