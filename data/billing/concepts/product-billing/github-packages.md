...
The storage amounts shown are **shared** with GitHub Actions. This means your total storage across Packages, Actions artifacts, and Actions caches cannot exceed the included amount for your plan.
