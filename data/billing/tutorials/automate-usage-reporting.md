...
For detailed examples and product-specific calculations, see [Introduction to billing and licensing](/en/billing/reference/previous-billing-platform-endpoints).