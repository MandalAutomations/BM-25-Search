...
Get insights into the usage of your  members.
...
4. To search or filter the graph, click the search bar. Then click the filter you want to use.

5. To further filter the graph, use the dropdown menus.
...
6. To request a CSV usage report, select **Get usage report** in the upper-right corner of the page.

   * For a breakdown of all metered usage, click **Metered billing usage report**.
   * For a per user breakdown of premium requests, click **Copilot premium requests usage report**.
...
6. To search or filter the graph, click the search bar. Then click the filter you want to use.

7. To further filter the graph, use the dropdown menus.
...
8. To request a CSV usage report, select **Get usage report** in the upper-right corner of the page.

   * For a breakdown of all metered usage, click **Metered billing usage report**.

   * For a per user breakdown of premium requests for the last 45 days, click **Copilot premium requests usage report**.
...
6. To download a CSV report of the license usage, click <svg version="1.1" width="16" height="16" viewBox="0 0 16 16" class="octicon octicon-kebab-horizontal" aria-label="Licensing dropdown" role="img"><path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path></svg> to the right of the usage you want to download, then click **<svg version="1.1" width="16" height="16" viewBox="0 0 16 16" class="octicon octicon-download" aria-label="download" role="img"><path d="M2.75 14A1.75 1.75 0 0 1 1 12.25v-2.5a.75.75 0 0 1 1.5 0v2.5c0 .138.112.25.25.25h10.5a.25.25 0 0 0 .25-.25v-2.5a.75.75 0 0 1 1.5 0v2.5A1.75 1.75 0 0 1 13.25 14Z"></path><path d="M7.25 7.689V2a.75.75 0 0 1 1.5 0v5.689l1.97-1.969a.749.749 0 1 1 1.06 1.06l-3.25 3.25a.749.749 0 0 1-1.06 0L4.22 6.78a.749.749 0 1 1 1.06-1.06l1.97 1.969Z"></path></svg> CSV report**.

## Further reading

* [Managing user licenses for an organization or enterprise](/en/billing/managing-your-billing/adding-licenses-to-an-organization)