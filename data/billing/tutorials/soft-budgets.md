# Start monitoring costs with soft budgets

Set soft budgets to monitor spending without blocking access to paid features while you build an understanding of your costs.
...
1. Review your current usage of licenses and metered products. See [Gathering insights on your spending](/en/billing/tutorials/gather-insights) and [Viewing your usage of metered products and licenses](/en/billing/how-tos/products/view-productlicense-use).
2. Identify any upcoming projects or initiatives that may increase your usage.
3. Calculate the estimated costs based on your usage patterns and any anticipated changes.
4. Decide on a budget amount that provides some flexibility above your estimated costs to accommodate unexpected usage spikes.

## 2. Set a soft budget

To set a budget for your enterprise or organization, see [Setting up budgets to control spending on metered products](/en/billing/tutorials/set-up-budgets#creating-a-budget).
