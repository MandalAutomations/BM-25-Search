...
13. Optionally, to create a new account and link your newly unlinked email, click **Create a new account**.
    > \[!NOTE]
    > You can also link your unlinked email to an existing GitHub account. See [Adding an email address to your GitHub account](/en/account-and-profile/setting-up-and-managing-your-personal-account-on-github/managing-email-preferences/adding-an-email-address-to-your-github-account).
