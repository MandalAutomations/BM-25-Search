# Managing team access to an organization project (classic)
...
> * If you add or remove project (classic) access for a parent team, each of that parent's child teams will also receive or lose access to the project (classic). For more information, see [About organization teams](/en/enterprise-server@3.16/organizations/organizing-members-into-teams/about-teams).
...
* [Adding your project to a team](/en/enterprise-server@3.16/issues/planning-and-tracking-with-projects/managing-your-project/adding-your-project-to-a-team)