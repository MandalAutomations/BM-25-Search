...
You can also use GitHub's APIs to retrieve information about your organization's members. For more information, see the [GraphQL API](/en/graphql/reference/objects#user) and [REST API](/en/rest/users) documentation.
