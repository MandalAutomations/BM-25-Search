...
GitHub Models automates, enhances, and streamlines AI-powered software development processes within GitHub. You can use GitHub Models to manage and optimize prompts, compare models, and create robust evaluations. See [About GitHub Models](/en/github-models/about-github-models).

## Prerequisites

For GitHub Models to be available to your organization, an enterprise owner must first enable the feature for the enterprise.  See [Enabling GitHub Models for an enterprise](/en/github-models/github-models-at-scale/manage-models-at-scale#enabling-github-models-for-an-enterprise).
...
You can also integrate your preferred external LLM models by bringing your own keys (BYOK) to GitHub Models. See [Using your own API keys in GitHub Models](/en/github-models/github-models-at-scale/set-up-custom-model-integration-models-byok)
