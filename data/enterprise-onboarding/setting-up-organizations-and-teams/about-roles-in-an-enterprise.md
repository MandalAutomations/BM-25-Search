...
Now that you understand roles, plan which roles will be required for your teams to do their jobs on GitHub. See [Identifying the roles required by your enterprise](/en/enterprise-cloud@latest/enterprise-onboarding/setting-up-organizations-and-teams/identify-role-requirements).