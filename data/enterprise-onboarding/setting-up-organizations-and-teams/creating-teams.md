...
Next, assign roles to teams to manage their access to settings and resources. See [Assigning roles to teams and users](/en/enterprise-cloud@latest/enterprise-onboarding/setting-up-organizations-and-teams/assigning-roles-to-teams-and-users).