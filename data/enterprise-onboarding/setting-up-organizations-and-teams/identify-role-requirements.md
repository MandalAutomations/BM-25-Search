...
Now that you've planned which roles will help your teams be productive and secure on GitHub, create custom roles for the permissions you need. Later, you will create teams to manage role assignments at scale. [Creating custom roles](/en/enterprise-cloud@latest/enterprise-onboarding/setting-up-organizations-and-teams/creating-custom-roles).