...
* [About GitHub's documentation philosophy](/en/contributing/writing-for-github-docs/about-githubs-documentation-philosophy)
* [About GitHub's documentation fundamentals](/en/contributing/writing-for-github-docs/about-githubs-documentation-fundamentals)
* [Content design principles](/en/contributing/writing-for-github-docs/content-design-principles)
...
* [Conceptual content](/en/contributing/style-guide-and-content-model/conceptual-content-type)
* [Referential content](/en/contributing/style-guide-and-content-model/referential-content-type)
* [Procedural content](/en/contributing/style-guide-and-content-model/procedural-content-type)
* [Troubleshooting content](/en/contributing/style-guide-and-content-model/troubleshooting-content-type)
* [Quickstart](/en/contributing/style-guide-and-content-model/quickstart-content-type)
* [Tutorial](/en/contributing/style-guide-and-content-model/tutorial-content-type)
...
For related information, see "Voice and tone" in [Style guide](/en/contributing/style-guide-and-content-model/style-guide#voice-and-tone) and [Writing content to be translated](/en/contributing/writing-for-github-docs/writing-content-to-be-translated).
...
* **Use formatting elements** to separate the content and create space on the page. For example:
  ...
  * Numbered lists
  * [Alerts](/en/contributing/style-guide-and-content-model/style-guide#alerts)
  * Tables
  * Visuals
...
* [Style guide](/en/contributing/style-guide-and-content-model/style-guide)
* [About the content model](/en/contributing/style-guide-and-content-model/about-the-content-model)
* [Contents of a GitHub Docs article](/en/contributing/style-guide-and-content-model/contents-of-a-github-docs-article)
