...
Use the following guidelines to ensure the content you create can be successfully translated. For more information, see [Style guide](/en/contributing/style-guide-and-content-model/style-guide).
