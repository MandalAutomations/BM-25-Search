...
For the referential content template, see [Templates](/en/contributing/writing-for-github-docs/templates#referential-article-template).
...
* For subjects with a single element to explain, use a list.
  * Example: [Repository roles for an organization](/en/organizations/managing-access-to-your-organizations-repositories/repository-permission-levels-for-an-organization#repository-roles-for-organizations)
* For subjects with multiple elements to explain, use a table.
  * Example: [Repository roles for an organization](/en/organizations/managing-access-to-your-organizations-repositories/repository-permission-levels-for-an-organization#permissions-for-each-role)
* For longer referential content, such as YAML syntax for workflows, use headers consistently.
  ...
  * Example: [Workflow syntax for GitHub Actions](/en/actions/reference/workflow-syntax-for-github-actions)
...
* Referential articles
  ...
  * [REST API endpoints for billing](/en/rest/reference/billing) in the REST API documentation
  * [Mutations](/en/graphql/reference/mutations) in the GraphQL API documentation
* Referential sections within other articles
  ...
  * "Hardware considerations" in [Installing GitHub Enterprise Server on AWS](/en/enterprise-server@3.20/admin/installation/installing-github-enterprise-server-on-aws#hardware-considerations)