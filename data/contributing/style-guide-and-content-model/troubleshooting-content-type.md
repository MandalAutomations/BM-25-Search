...
* You can create a troubleshooting map topic if a product or feature has many troubleshooting articles, for example [Troubleshooting SSH](/en/authentication/troubleshooting-ssh).
...
* [Using GitHub Enterprise Server with a load balancer](/en/enterprise-server@3.20/admin/configuration/configuring-network-settings/using-github-enterprise-server-with-a-load-balancer#troubleshooting-connectivity-through-a-load-balancer)
