...
Same response schema as [Add a dependency an issue is blocked by](#add-a-dependency-an-issue-is-blocked-by).
...
Same response schema as [List dependencies an issue is blocked by](#list-dependencies-an-issue-is-blocked-by).