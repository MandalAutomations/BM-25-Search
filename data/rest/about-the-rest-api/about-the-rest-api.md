...
* [Getting started with the REST API](/en/rest/guides/getting-started-with-the-rest-api)
...
* [Authenticating to the REST API](/en/rest/overview/authenticating-to-the-rest-api)
...
For a list of libraries to facilitate scripting with the REST API, see [Libraries for the REST API](/en/rest/overview/libraries-for-the-rest-api).
...
* [Comparing GitHub's REST API and GraphQL API](/en/rest/overview/comparing-githubs-rest-api-and-graphql-api)
...
* [Troubleshooting the REST API](/en/rest/overview/troubleshooting-the-rest-api)