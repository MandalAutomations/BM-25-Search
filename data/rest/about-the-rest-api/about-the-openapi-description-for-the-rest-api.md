...
For each product, if date-based versioning is supported, there is also a description for each date-based version. For more information, see [API Versions](/en/rest/overview/api-versions).
