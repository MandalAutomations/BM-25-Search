...
in a GitHub pull request. For more information about the relevant endpoints, see [REST API endpoints for commit statuses](/en/rest/commits/statuses).
...
to [use it](/en/webhooks-and-events/webhooks/configuring-your-server-to-receive-payloads#using-ngrok). We find it to be a very useful tool for exposing local
applications to the internet.

> \[!NOTE]
> Alternatively, you can use webhook forwarding to set up your local environment to receive webhooks. For more information, see [Using the GitHub CLI to forward webhooks for testing](/en/webhooks-and-events/webhooks/receiving-webhooks-with-the-github-cli).
...
[a personal access token](/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token):
