...
1. On GitHub, navigate to the main page of the repository. For organization discussions, navigate to the main page of the source repository.
...
4. Optionally, in the upper-right corner of the page, select the **Period** dropdown menu and click the time period for which you want to view data: **30 days**, **3 months**, or **1 year**.