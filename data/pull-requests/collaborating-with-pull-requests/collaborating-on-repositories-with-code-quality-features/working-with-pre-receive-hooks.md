...
Your GitHub Enterprise Server site administrator can create and remove pre-receive hooks for your organization or repository, and may allow organization or repository administrators to enable or disable pre-receive hooks. For more information, see [Enforcing policy with pre-receive hooks](/en/enterprise-server@3.20/admin/policies/enforcing-policy-with-pre-receive-hooks).