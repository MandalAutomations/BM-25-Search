...
> \[!TIP]
> You can also mark a pull request as ready for review using the GitHub CLI. For more information, see [`gh pr ready`](https://cli.github.com/manual/gh_pr_ready) in the GitHub CLI documentation.
