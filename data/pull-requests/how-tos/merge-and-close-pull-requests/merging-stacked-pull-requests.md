...
> \[!NOTE]
>
> * If you merge via the API and want to use stacked pull requests, you'll need to update your code to use the new merge API for stacks. See [Stacked pull requests in the REST and GraphQL APIs](/en/pull-requests/reference/stacked-pull-requests-rest-and-graphql-apis).
