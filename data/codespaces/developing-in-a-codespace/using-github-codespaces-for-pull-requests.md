...
Using a codespace to work on a pull request gives you all the benefits of GitHub Codespaces. For more information, see [GitHub Codespaces features](/en/codespaces/about-codespaces/codespaces-features).
