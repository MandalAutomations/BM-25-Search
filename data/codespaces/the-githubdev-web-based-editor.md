...
> \[!NOTE] The github.dev editor is currently in public preview. You can provide feedback [in our Discussions](https://github.com/community/community/discussions/categories/codespaces).
...
| `https://vscode-sync-insiders.trafficmanager.net` | *Optional.* To allow settings to be synchronized via Settings Sync.                                               |
